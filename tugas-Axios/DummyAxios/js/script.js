...
function allPelanggan() {
  axios
    .get("http://localhost/php/pelanggan/select.php")
    .then(function (response) {
...
function addPelanggan() {
  ...
  axios
    .post(
      "http://localhost/php/pelanggan/insert.php",
      JSON.stringify(data)
    )
    .then(function (response) {
...
function cariPelanggan(id) {
  ...
  axios
    .post(
      "http://localhost/php/pelanggan/cariData.php",
      JSON.stringify(data)
    )
    .then(function (response) {
...
function updatePelanggan() {
  ...
  axios
    .post(
      "http://localhost/php/pelanggan/update.php",
      JSON.stringify(data)
    )
    .then(function (response) {
...
function delPelanggan(id) {
  ...
  axios
    .post(
      "http://localhost/php/pelanggan/delete.php",
      JSON.stringify(data)
    )
    .then(function (response) {
...
function checkOut(idbrg, brg, hrg) {
  ...
  axios
    .post(
      "http://localhost/php/pelanggan/addtocart.php",
      JSON.stringify(data)
    )
    .then(function (response) {
      document.querySelector("#pesan").innerHTML = response.data;
